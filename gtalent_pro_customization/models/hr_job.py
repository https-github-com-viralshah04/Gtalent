...
class Job(models.Model):
    ...
    industry_type_id = fields.Many2one('hr.recruitment.industry', string="Industry Type")
    ...
    job_type = fields.Selection([('permanent','Permanent'), ('contract','Contract'), ('intern','Intern')], string='Job Type')
    candidate_type = fields.Selection([('experience', 'Experience'), ('fresher', 'Fresher'), ('contractor', 'Contractor')], string='Candidate Type')
